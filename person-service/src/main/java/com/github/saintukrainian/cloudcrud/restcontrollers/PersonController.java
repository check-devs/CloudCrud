 ...
 * @version 1.0.0
 *     <p>The {@code PersonController} class handles all requests related to {@code Person} entity.
 */
@RestController
...
public class PersonController {
  ...
  public HttpStatus updatePerson(
      @PathVariable("id") int userId, @RequestBody Person updatedPerson) {
