...
public class PersonControllerTest extends AbstractTest {
  ...
  public void getPersonsList() throws Exception {
    MvcResult mvcResult =
        mvc.perform(
                MockMvcRequestBuilders.get(PERSONS_URL).accept(MediaType.APPLICATION_JSON_VALUE))
            .andReturn();
  ...
  public void deletePersonAndDetailsIfExist() throws Exception {
    ...
    mvcResult =
        mvc.perform(MockMvcRequestBuilders.delete(PERSONS_URL + person.getId())).andReturn();
